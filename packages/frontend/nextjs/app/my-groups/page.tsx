...
import { SignOut, User, MapPin, Clock, Calendar, Plus, List } from "@phosphor-icons/react"
              ...
              <Sheet open={isMobileNavOpen} onOpenChange={setIsMobileNavOpen}>
                ...
                <SheetContent side="left" className="w-[320px] p-0">
                  <SheetHeader className="px-5 py-4 border-b">
                    ...
                    <div className="text-xs text-muted-foreground">Мои группы</div>
                  </SheetHeader>
                  ...
                  <div className="p-3 space-y-1">
                    {mobileNavItems.map((item) => (
                      <Button
                        key={item.path}
                        variant={item.path === '/my-groups' ? 'secondary' : 'ghost'}
